...
fun ChatMessageList(
    ...
    // Avatar del personaje activo — se muestra al lado de cada mensaje del modelo
        ...
        LazyColumn(
            ...
            if (isGenerating && !streamingResponse.isNullOrEmpty()) {
                item(key = "streaming_response") {
                    ...
                    // Row con avatar también durante streaming
                    androidx.compose.foundation.layout.Row(
                        ...
                        androidx.compose.foundation.layout.Box(
                            modifier = Modifier
                                ...
                                .androidx.compose.foundation.background(NeonElevated),
                            contentAlignment = Alignment.Center
                        ) {
                            if (personaAvatarUri != null) {
                                coil.compose.AsyncImage(
                                    model = java.io.File(personaAvatarUri),
                ...
                item(key = "pre_response_typing") {
                    Row(
                        ...
                        val indicatorText = when {
                            isAnalyzingDocument -> stringResource(R.string.chat_analyzing_document)
                            isAnalyzingMedia -> "Analyzing image..."
                            else -> "Thinking..."
                        }
                        ThinkingIndicator(
                            text = indicatorText,
