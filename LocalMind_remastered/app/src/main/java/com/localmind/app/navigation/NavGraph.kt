...
object Routes {
    ...
    const val CHARACTER_EDITOR = "character_editor?personaId={personaId}"
    ...
    NavHost(
        ...
        composable(Routes.PERSONA_HUB) {
            PersonaHubScreen(
                ...
                onEditCharacter = { personaId ->
                    navController.navigate("character_editor?personaId=${Uri.encode(personaId)}")
                },
                onCreateCharacter = {
                    navController.navigate("character_editor?personaId=")
                }
            )
        }
        ...
        composable(
            ...
            CharacterEditorScreen(
                personaId = personaId.ifBlank { null },
                onNavigateBack = { navController.popBackStack() }
            )
        }
