    ...
    Scaffold(
        ...
        Column(
            ...
            AdvancedInferenceSection(
                ...
                onNKeepChange = { viewModel.updateNKeep(it) },
                onDefragTholdChange = { viewModel.updateDefragThold(it) },
                onContextShiftChange = { viewModel.updateContextShift(it) },
                onFullSwaCacheChange = { viewModel.updateFullSwaCache(it) },
                onSaveLocalKvChange = { viewModel.updateSaveLocalKv(it) }
            )
